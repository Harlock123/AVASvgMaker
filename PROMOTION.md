...
**Numbers that are checked, not rounded.** 167 stencils. Six builds: Windows, macOS and Linux,
...
**Full description**
    ...
    from a toolbox of 167 stencils onto a page, label them, and join them with connectors
...
>
> You drag shapes from a toolbox of 167 stencils onto a page, label them, and join them with
